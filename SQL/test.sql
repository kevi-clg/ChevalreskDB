...
INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('plastron',23,'Armure',13,'armure.png');
INSERT INTO armures (id,matiere,taille) VALUES (7,'acier','m');

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('jambiere',12,'Armure',15,'armure.png');
INSERT INTO armures (id,matiere,taille) VALUES (8,'or','x');

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('botte',30,'Armure',12,'armure.png');
INSERT INTO armures (id,matiere,taille) VALUES (9,'bronze','l');

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('bracelet',28,'Armure',18,'armure.png');
INSERT INTO armures (id,matiere,taille) VALUES (10,'diamant','s');

/*table Potions*/
INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('potion de force',10,'Potion',16,'potion.png');
INSERT INTO potions (id,effect,duree,type) VALUES (11,'vous donne de la force',23,'potions');

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('potion de vitesse',11,'Potion',16,'potion.png');
INSERT INTO potions (id,effect,duree,type) VALUES (12,'vous donne de la vitesse',12,'potions');

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('potion de jump',13,'Potion',16,'potion.png');
INSERT INTO potions (id,effect,duree,type) VALUES (13,'vous permet de sauter plus haut',11,'potions');

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('poison',12,'Potion',16,'potion.png');
INSERT INTO potions (id,effect,duree,type) VALUES (14,'ceci est un poison',9,'potions');

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('potion de resurection',14,'Potion',112,'potion.png');
INSERT INTO potions (id,effect,duree,type) VALUES (15,'vous ramene a la vie',20,'potions');

/*table Elements*/
INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('dent de dragon',8,'Élément',153,'elements.png');
INSERT INTO éléments (id,type,rarete,dangerosite) VALUES (16,'éléments',5,10);

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('larme de licorne',3,'Élément',250,'elements.png');
INSERT INTO éléments (id,type,rarete,dangerosite) VALUES (17,'éléments',5,1);

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('poil de loup',32,'Élément',43,'elements.png');
INSERT INTO éléments (id,type,rarete,dangerosite) VALUES (18,'éléments',1,3);

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('sang de liche',11,'Élément',99,'elements.png');
INSERT INTO éléments (id,type,rarete,dangerosite) VALUES (19,'éléments',2,4);

INSERT INTO items (nom,quantite,typee,prix,photo) VALUES ('poudre d os de mort vivant',26,'Élément',53,'elements.png');
